...
$item2 = 'clientes';
$item3 = 'agenda';
$item4 = 'parte_contraria';
$item5 = 'processos';
$item6 = 'audiencias';
$item7 = 'historico';
$item8 = 'pasta_processo';
          ...
          <div class="rd-navbar-main">
            ...
            <div class="rd-navbar-panel">
              ...
              <div class="rd-navbar-brand">
                <!--Brand--><a class="brand" href="index.php"><img class="brand-logo-dark" src="../img/logo.png" alt="" width="146" height="22"/><img class="brand-logo-light" src="../img/logobranca.png" alt="" width="146" height="22"/></a>
              </div>
            </div>
              ...
              <div class="rd-navbar-nav-wrap">
                <ul class="rd-navbar-nav">
                 ...
                 <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item1 ?>">Home</a>
                  ...
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item3 ?>">Tarefas</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item4 ?>">Réu</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item6 ?>">Audiências</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item7 ?>">Andamento Processo</a>
                  </li>
                  <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item8 ?>">Pasta Processo</a>
                  </li>
                </ul>
              </div>
            </div>
