...
$res = $pdo->prepare("UPDATE parte_contraria set nome = :nome, telefone = :telefone, email = :email, endereco = :endereco , obs = :obs, tipo_pessoa = :tipo_pessoa where id = :id ");
