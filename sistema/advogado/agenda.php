					...
					<div class="row">
						<div class="col-md-4 col-sm-12">
							<div class="form-group">
								...
								<input type="hidden" id="antigo"  name="antigo" value="<?php echo @$hora ?>" required>
								<input type="hidden" id="antigo2"  name="antigo2" value="<?php echo @$data ?>" required

								<label for="exampleFormControlInput1">Nome</label>
								<input type="text" class="form-control" id="nome" maxlength="35" placeholder="Insira o Nome" name="nome" value="<?php echo @$nome ?>" required>
							</div>
						</div>
						...
						<div class="col-md-8 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" id="descricao" name="descricao" maxlength="100" placeholder="Insira a Descrição" required value="<?php echo @$descricao ?>">
						...
						<div class="row">
							<div class="col-md-4 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="num_processo" maxlength="35"  name="num_processo" value="<?php echo @$num_processo ?>" disabled>
								</div>
							</div>
							...
							<div class="col-md-8 col-sm-12">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="cliente" name="cliente" disabled value="<?php echo @$nome_cliente ?>">
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control form-control-sm mr-sm-2" type="date" id="data" name="data" value="<?php echo $data ?>">					
							</div>
						</div>						
						...
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input class="form-control form-control-sm mr-sm-2" type="time" id="hora"   name="hora"  value="<?php echo $hora ?>">
							</div>
						</div>
					</div>
...
<!--CHAMADA DA MODAL CONCLUIR TAREFA -->
<?php 
