...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-info">Novo Estado Civil</a>
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					//BUSCAR DADOS DO REGISTRO A SER EDITADO
						$res = $pdo->query("select * from estado_civil where id = '$id_reg'");
						$dados = $res->fetchAll(PDO::FETCH_ASSOC);
						$nome = $dados[0]['nome'];

						

						echo 'Edição de Estado Civil';
					}else{
						$nome_botao = 'Salvar';
						echo 'Cadastro de Estado Civil';
					} ?>
				</h5>
