                ...
                <div class="rd-navbar-main">
                  ...
                  <div class="rd-navbar-panel">
                    ...
                    <div class="rd-navbar-brand">
                      <!--Brand--><a class="brand" href="index.php"><img class="brand-logo-dark" src="../img/logo.png" alt="" width="146" height="22"/><img class="brand-logo-light" src="../img/logobranca.png" alt="" width="155" height="22"/></a>
                    </div>
                  </div>
                  <div class="rd-navbar-main-element">
                    <div class="rd-navbar-nav-wrap">
                      <ul class="rd-navbar-nav">
                        ...
                        <li class="rd-nav-item"><a class="rd-nav-link" href="index.php?acao=<?php echo $item8 ?>">Estado Civil</a>
                        </li>

                        <li class="rd-nav-item">
                          <a class="rd-nav-link" id="v-pills-messages-tab" href="backup.php" role="tab" aria-controls="v-pills-messages" aria-selected="false">Backup do Banco</a>
                        </li>
                      </ul>
                    </div>
                  </div>
