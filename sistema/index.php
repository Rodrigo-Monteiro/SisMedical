...
if($linhas_usuarios == 0){
 ...
 <!DOCTYPE html>
<html style="background: linear-gradient(to bottom, #b08b8c,#cab0b1);">
<head>
...
<div class="copy-text"><a title="Clique aqui para recuperar a senha!" href="" data-toggle="modal" data-target="#modal-recuperar" class="text-dark">Recuperar Senha</a></div>
		</div>
