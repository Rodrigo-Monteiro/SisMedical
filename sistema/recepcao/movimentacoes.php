		...
		<div class="col-md-9 col-sm-12">
			<div class="float-right mr-4">
				<form id="frm" class="form-inline my-2 my-lg-0" method="post">
					...
					<select class="form-control form-control-sm mr-sm-4" id="txtbuscar" name="txtbuscar">
...
<!--AJAX PARA BUSCAR OS DADOS PELA PELA TXT -->
<script type="text/javascript">
...
<!--AJAX PARA BUSCAR OS DADOS PELA PELA DATA INICIAL -->
<script type="text/javascript">
...
<!--AJAX PARA BUSCAR OS DADOS PELA PELA DATA FINAL -->
<script type="text/javascript">
