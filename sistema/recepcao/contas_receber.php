		...
		<div class="col-md-6 col-sm-12">
			...
			<div class="float-right mr-4">
				<form id="frm" class="form-inline my-2 my-lg-0" method="post">
					...
					<input class="form-control form-control-sm mr-sm-2" type="text" name="txtbuscar2" id="txtbuscar2" placeholder="Nome ou CPF/CNPJ do Cliente" ">
...
<!--AJAX PARA BUSCAR OS DADOS PELA TROCA NA TXT -->
<script type="text/javascript">
