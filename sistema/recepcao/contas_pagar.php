...
<div class="row botao-novo">
	<div class="col-md-12">
		...
		<a href="index.php?acao=<?php echo $pagina ?>&funcao=novo"  type="button" class="btn btn-secondary">Nova Conta a Pagar</a>
				...
				<form id="form" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="exampleFormControlInput1">Data de Vencimento</label>
							<input class="form-control form-control-sm mr-sm-2" type="date" name="data_vencimento" id="data_vencimento" value="<?php echo $agora ?>">
					</div>
